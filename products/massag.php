                                 ...
                                 $customer_id = $_SESSION['customer_id'];
                                  ...
                                  if (isset($_GET['massag'])) {
                                      ...
                                      $get_massag_pro =
                                         ...
                                         where c.id ='$customer_id' and sb.id= '$massag_id'";
                                      ...
                                      if ($count_massag == 0) {
                                          ...
                                          while($row_massag_pro=mysqli_fetch_array($run_massag_pro)){
                                              ...
                                              $pro_name = $row_massag_pro['product_name'];
                                              $pro_manu = $row_massag_pro['product_manufacturer'];
                                              $pro_price = $row_massag_pro['product_price'];
                                              $pro_dist = $row_massag_pro['company_name'];
                                              $pro_min_order = $row_massag_pro['product_min_order'];
                                              $pro_expires = $row_massag_pro['expires'];
                                              $pro_desc = $row_massag_pro['discription'];
                                              ?>
                           <tbody>
                        <tr>
                           <th data-priority="1"
