                           ...
                           <?php    
                              ...
                              if(isset($_SESSION['customer_id'])){
                                  ...
                                  if (isset($_GET['viz'])) {
                                      ...
                                      $count_viz = mysqli_num_rows($run_viz_pro);
                                      if ($count_viz == 0) {
                                          echo "<h2 style='text-align:center;'>'Нет продукта'</h2>";
                                      }else{
                              
                                          while($row_viz_pro=mysqli_fetch_array($run_viz_pro)){
                                              $pro_id = $row_viz_pro['product_id'];
                                              $pro_name = $row_viz_pro['product_name'];
                                              $pro_manu = $row_viz_pro['product_manufacturer'];
                                              $pro_price = $row_viz_pro['product_price'];
                                              $pro_dist = $row_viz_pro['company_name'];
                                              $pro_min_order = $row_viz_pro['product_min_order'];
                                              $pro_expires = $row_viz_pro['expires'];
                                              $pro_desc = $row_viz_pro['discription'];
                                              ?>
                           <tbody>
                        <tr>
                           <th data-priority="1"
