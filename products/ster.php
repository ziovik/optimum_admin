                                ...
                                $customer_id = $_SESSION['customer_id'];
                                  ...
                                  if (isset($_GET['ster'])) {
                                      ...
                                      $get_ster_pro =
                                         ...
                                         where c.id ='$customer_id' and sb.id= '$ster_id'";
                              
                                      $run_ster_pro = mysqli_query($con, $get_ster_pro);
                              
                                      $count_ster = mysqli_num_rows($run_ster_pro);
                                      if ($count_ster == 0) {
                                          echo "<h2 style='text-align:center;'>'Нет продукта'</h2>";
                                      }else{
                              
                                          while($row_ster_pro=mysqli_fetch_array($run_ster_pro)){
                                              $pro_id = $row_ster_pro['product_id'];
                                              $pro_name = $row_ster_pro['product_name'];
                                              $pro_manu = $row_ster_pro['product_manufacturer'];
                                              $pro_price = $row_ster_pro['product_price'];
                                              $pro_dist = $row_ster_pro['company_name'];
                                              $pro_min_order = $row_ster_pro['product_min_order'];
                                              $pro_expires = $row_ster_pro['expires'];
                                              $pro_desc = $row_ster_pro['discription'];
                                              ?>
                          <tbody>
                        <tr>
                           <th data-priority="1"
