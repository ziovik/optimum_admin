		...
		<div class="container">
			<ul class="breadcrumb">
				...
				<li class="active">
					<?php
					if (isset($_GET['sub_category_id'])) {
						$category = get_category_by_id($sub_category->category_id);
					}
					?>
...
where c.id ='$customer_id' and sc.id= '$sub_category_id'
";
									...
									if ($result = $con->query($sql)) {
										...
										while ($row = $result->fetch_assoc()) {
											...
											<tr>
												<td data-priority="1"
													style="background: white; color: #400040;"><?php echo $pro_dist; ?></td>
