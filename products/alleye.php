      ...
      <div id="breadcrumb">
         <div class="container">
            <ul class="breadcrumb">
               ...
               <li class="active">Ресницы и брови</li>
            </ul>
         </div>
      </div>
      <!-- /BREADCRUMB -->
                        ...
                        <thead>
                           ...
                           <?php
                              ...
                              if (isset($_GET['alleye'])) {
                                ...
                                $count_alleye = mysqli_num_rows($run_alleye_pro);
                              
                                if ($count_alleye == 0) {
                                    echo "<h2 style='text-align:center;'>Нет продукта</h2>";
                                                          } else {
                                    while($row_alleye_pro=mysqli_fetch_array($run_alleye_pro)) {
                                        $pro_id = $row_alleye_pro['product_id'];
                                        $pro_name = $row_alleye_pro['product_name'];
                                        $pro_manu = $row_alleye_pro['product_manufacturer'];
                                        $pro_price = $row_alleye_pro['product_price'];
                                        $pro_dist = $row_alleye_pro['company_name'];
                                                                  $pro_min_order = $row_alleye_pro['product_min_order'];
                                                                  $pro_expires = $row_alleye_pro['expires'];
                                                                  $pro_desc = $row_alleye_pro['discription'];
