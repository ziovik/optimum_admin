                                 ...
                                 $customer_id = $_SESSION['customer_id'];
                                  ...
                                  if (isset($_GET['tatu'])) {
                                      ...
                                      $get_tatu_pro =
                                         ...
                                         where c.id ='$customer_id' and sb.id= '$tatu_id'";
                              
                                      $run_tatu_pro = mysqli_query($con, $get_tatu_pro);
                              
                                      $count_tatu = mysqli_num_rows($run_tatu_pro);
                                      if ($count_tatu == 0) {
                                          echo "<h2 style='text-align:center;'>'Нет продукта'</h2>";
                                      }else{
                              
                                          while($row_tatu_pro=mysqli_fetch_array($run_tatu_pro)){
                                              $pro_id = $row_tatu_pro['product_id'];
                                              $pro_name = $row_tatu_pro['product_name'];
                                              $pro_manu = $row_tatu_pro['product_manufacturer'];
                                              $pro_price = $row_tatu_pro['product_price'];
                                              $pro_dist = $row_tatu_pro['company_name'];
                                              $pro_min_order = $row_tatu_pro['product_min_order'];
                                              $pro_expires = $row_tatu_pro['expires'];
                                              $pro_desc = $row_tatu_pro['discription'];
                                              ?>
                           <tbody>
                        <tr>
                           <th data-priority="1"
