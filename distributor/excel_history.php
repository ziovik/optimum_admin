...
if (isset($_SESSION['distributor_id'])) {
    ...
    if (isset($_GET['customer_id'])) {
        if (isset($_GET['order_id'])) {
            ...
            if (isset($_POST['export_excel_history'])) {
               ...
               where d.id = '$dist_id'  AND  c.id = '$customer_id' AND so.id='$order_id' AND (pt.onscreen_status = 'Принял' OR pt.onscreen_status = 'Отказ' )
                      ";
      ...
      <table>
       ...
       ';
                ...
                $get_product = "select 
                         ...
                         where d.id = '$dist_id' AND crt.customer_id = '$customer_id' AND so.id='$order_id' AND (pt.onscreen_status = 'Принял' OR pt.onscreen_status = 'Отказ' )
                         ";
            ...
            header("Content-Disposition: attachment; filename=download1.cvs");
            echo $output;
