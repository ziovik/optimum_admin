            ...
            <div id="main" class="col-md-12">
                ...
                <div id="store">
                   ...
                   from distributor d
                                ...
                                <tr style="text-align: center">
                                    ...
                                    <td style="text-align: center">
                                        ...
                                        <li style="text-align: center" class="header-cart dropdown default-dropdown">
                                            ...
                                            <div class="header-btns-icon">
                                                <input id="customer_id" type="hidden" value="<?php
                                                echo $customer_id;
                                                ?>">
                                                <a  href="index1.php?customer_id=<?php
                                                echo $customer_id;
                                                ?>
                               &customer_name=<?php
                                                echo $customer_name;
                    ...
                    <!-- row -->
                    <div class="row"><br><br>
                        <h2 style="color: #800080; text-align: center;"><?php
                            echo @$_GET['logged_in'];
                            ?></h2>
...
<?php
include("inc_distributor/footer.php");
?>
