<div style="float: right;">
    <form method="post" action="excel_history.php?action=<?php echo $order_id; ?>">
        <input type="submit" id="btnID" name="export_excel" class="btn btn-success" value="Печать Заказы">
    </form>
</div>
