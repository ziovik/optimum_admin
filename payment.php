         ...
         <li class="dropdown side-dropdown">
            ...
            <div class="row">
               <div class="col-md-4">
                  <ul class="list-links">
                     <li>
                        <h3 class="list-links-title"><a href="products/allcosm.php?allcosm=1" name="allcosm">Косметология</a>  </h3>
                     </li>
                     <?php
                        if (!isset($_GET['cosm'])) {
      ...
      <div class="section">
         ...
         <div class="container">
            ...
            <div class="row">
               <!-- section -->
               <div class="section">
                  <input style="color: white;" class="btn next-btn" type="submit" value="OPTIMUM BEAUTY" onClick="optimum()">';
                  <script type="text/javascript">
                     function optimum() {
                     window.location = "optimum_beauty.php";
                     }
                  </script>
                  <br><br>
                  <div class="panel-footer">
                     <form action="" method="post" enctype="multipart/form-data" style="padding-left: 300px;">
                        ...
                        <tr >
                           ...
                           <td><button class="btn next-btn" name="send_distributor">Сделать Заказ</button></td>
                        </tr>
                     </form>
                  </div>
                  <?php
