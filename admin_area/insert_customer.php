 ...
 ?>
  ...
  <form action="" method="post" enctype="multipart/form-data">
    <table align="center" width="900px;" border="2" bgcolor="#F6F7F8">
      <h2 style="text-align: center;">Insert New Customer here</h2>

      
      <tr>
        <td align="right" style="width: 150px;"><b>Customer Name:</b></td>
          <td>
             <input type="text" name="customer_name" size="80" required>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
            <input type="text" name="index_code" size="100" required>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input type="text" name="building" size="50" required></td>
      </tr>
      
      <tr>
        <td align="right"><b>House:</b></td>
        <td><input type="text" name="house" size="50" required></td>
      </tr>
     ...
     <tr>
      ...
      <tr>
        ...
        <td colspan="8"><input type="submit" name="insert_customer" class="btn btn-success" value="Insert New Customer"></td>
      </tr>
    </table>
  </form>
...
<?php
  ...
  if (isset($_POST['insert_customer'])) {
   ...
   $credentials_id = $row_credentials_id['id'];
    ...
    (name, contact_id, region_id, address_id, credentials_id ) values
    ('$name', '$contact_id', '$region', '$address_id', '$credentials_id')";


    //execute query

    $result_insert_customer = mysqli_query($con, $insert_customer);

    if ($result_insert_customer) {
      echo "<script>alert('Customer has been added succesfully')</script>";
