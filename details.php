                ...
                <div class="product product-details clearfix">
                    ...
                    <div class="col-md-9">
                        <div class="product-body">
                            ...
                            <h2 class="product-name" style="text-align: justify; width:100%;font-size: 16px;"><?php echo $pro_name; ?></h2>
                            ...
                            <div class="product-btns">
                                ...
                                <button  id="add_to_cart_btn" class="primary-btn add-to-cart" style=" border-radius: 5px; padding-left: 2px;">
