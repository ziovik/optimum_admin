    ...
    if (isset($_GET['action'])) {
        ...
        if (isset($_POST['export_excel_history'])) {
            ...
            $sql = "select 
             ...
             where cc.customer_id= '$customer_id' AND so.id = '$order_id' AND (pt.onscreen_status = 'Принял' OR pt.onscreen_status = 'Отказ' ) ";
      ...
      ';
              ...
              where c.customer_id= '$customer_id' AND so.id = '$order_id' AND (pt.onscreen_status = 'Принял' OR pt.onscreen_status = 'Отказ' ) ";
